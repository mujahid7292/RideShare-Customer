package com.sand_corporation.www.uthao.NavigationMenuRecyclerView;
...
import com.sand_corporation.www.uthao.CustomerDummyHistoryActivity;
import com.sand_corporation.www.uthao.CustomerHistoryActivity;
import com.sand_corporation.www.uthao.CustomerSettingsActivity;
import com.sand_corporation.www.uthao.HelpBox.HelpBoxActivity;
import com.sand_corporation.www.uthao.Home;
import com.sand_corporation.www.uthao.NotificationBoxActivity;
import com.sand_corporation.www.uthao.PaymentGateWay.PaymentBoxActivity;
import com.sand_corporation.www.uthao.PromotionBoxActivity;
    ...
    public void onBindViewHolder(final MyViewHolder holder,  int position) {
        ...
        holder.singleNavigationMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String ride_history = view.getContext().getResources().getString(R.string.ride_history);
                String fair_estimation_history = view.getContext().getResources().getString(R.string.fair_estimation_history);
                String promotions = view.getContext().getResources().getString(R.string.promotions);
                String notification = view.getContext().getResources().getString(R.string.notification);
                String payment = view.getContext().getResources().getString(R.string.payment);
                String help = view.getContext().getResources().getString(R.string.help);
                String settings = view.getContext().getResources().getString(R.string.settings);
                String language = view.getContext().getResources().getString(R.string.language);

                if (10 == holder.getAdapterPosition()){
                    Intent intent = new Intent(view.getContext(), CustomerHistoryActivity.class);
                    view.getContext().startActivity(intent);//Without context we will not be able to startActivity.

                } else if (0 == holder.getAdapterPosition()){
                    Intent intent = new Intent(view.getContext(), CustomerDummyHistoryActivity.class);
                    view.getContext().startActivity(intent);//Without context we will not be able to startActivity.
                ...
                view.getContext().startActivity(intent);//Without context we will not be able to startActivity.
                    ...
                    Intent intent = new Intent(view.getContext(), CustomerSettingsActivity.class);
                    view.getContext().startActivity(intent);//Without context we will not be able to startActivity.
